    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Processing Video</h1>
          <p className="text-gray-600 mb-4">Please wait while we analyze and create your clips...</p>
          ...
          <p className="text-sm text-gray-500 mt-2">{jobStatus.progress}% complete</p>
        </div>
      </div>
    )
  }
